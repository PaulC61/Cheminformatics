...
kf100000_RMSD_matrix = np.transpose(np.array([all_0_2[:,0],all_0_2[:,1], all_0_4[:,1], all_0_6[:,1], all_0_8[:,1], all_1_0[:,1]]))

_,extractBins0_2_org,_ = plt.hist(kf100000_RMSD_matrix[:,1], bins=100, histtype=u'step')
_,extractBins0_4_org,_ = plt.hist(kf100000_RMSD_matrix[:,2], bins=100, histtype=u'step')
_,extractBins0_6_org,_ = plt.hist(kf100000_RMSD_matrix[:,3], bins=100, histtype=u'step')
_,extractBins0_8_org,_ = plt.hist(kf100000_RMSD_matrix[:,4], bins=100, histtype=u'step')
_,extractBins1_0_org,_ = plt.hist(kf100000_RMSD_matrix[:,5], bins=100, histtype=u'step')

# exercice 1.1 (multiplier chaque élément)
lst=[5,0,50,200]
def multipl_lst(lst):
...
# exercice 1.2 (créer un liste, div 2 ou 3)
lst=[]
...
# exercice 1.3 (créer un nouveau list dont chaque element*2)
lst=[5,0,50,200]
lst2=[]
for i in range (len(lst)):
	lst2+=[lst[i]*2]
...
# exercice 1.4 (coordonnées des pixels)
